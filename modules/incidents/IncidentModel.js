...
const IncidentSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['MEDICAL_EMERGENCY','CROWD_MANAGEMENT','THEFT_DETECTION','FLAME_DETECTION' , 'POOR_AIR_QUALITY','HIGH_HUMIDITY' , 'FIRE_DETECTION', "LOW_PRESSURE", "HIGH_PRESSURE" ,'WEAPON_DETECTION',  'BEHAVIOR_ANOMALY',     
