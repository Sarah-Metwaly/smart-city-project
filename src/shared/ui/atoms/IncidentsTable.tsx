...
// ─── Mobile card row ──────────────────────────────────────────────────────────
function MobileCard({ incident, idx }: { incident: any; idx: number }) {
  ...
  return (
    <div
      className="row-in relative rounded-xl p-4 space-y-3"
      style={{
        animationDelay: `${idx * 35}ms`,
        background:
          idx % 2 === 0 ? "transparent" : "rgba(10,14,20,0.25)",
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <span
          ...
          style={{ color: "rgba(180,195,204,0.45)" }}
        >
          {time}
        </span>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs" style={{ color: "rgba(180,195,204,0.75)" }}>
          {incident.type}
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <Badge
          ...
          textClass={sev.text}
          bgBorder={sev.bgBorder}
        />
        <Badge
          text={incident.status}
          textClass={res.text}
          bgBorder={res.bgBorder}
          pulse={res.pulse}
        />
      </div>
    </div>
...
// ─── Desktop table row ────────────────────────────────────────────────────────
function TableRow({ incident, idx }: { incident: any; idx: number }) {
  ...
  return (
    <tr
      className="row-in border-b transition-colors duration-200"
      style={{
        animationDelay: `${idx * 35}ms`,
    ...
    >
      ...
      {/* Time — hidden on tablet, visible on lg+ */}
      ...
      {/* Type — hidden on sm, visible on md+ */}
      <td className="py-3.5 px-4 hidden md:table-cell">
        <div className="flex items-center gap-2">
          ...
          <span
            className="text-xs"
            style={{ color: "rgba(180,195,204,0.75)" }}
          >
            {incident.type}
          </span>
        </div>
...
function Skeleton({ idx }: { idx: number }) {
  const widths = ["w-20", "w-14", "w-28", "w-20", "w-12", "w-14"];
  return (
    <tr
      className="border-b"
      style={{
      ...
      {widths.map((w, i) => (
        <td key={i} className="py-4 px-4">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg,#1E3A46 25%,#2a4f60 50%,#1E3A46 75%)",
      ...
      <div className="flex justify-between">
        <div
          ...
          style={{
            ...
            backgroundSize: "200% 100%",
            animation: `shimmer 1.6s ease-in-out ${idx * 80}ms infinite`,
          }}
        />
        <div
          ...
          style={{
            background: "linear-gradient(90deg,#1E3A46 25%,#2a4f60 50%,#1E3A46 75%)",
            backgroundSize: "200% 100%",
            animation: `shimmer 1.6s ease-in-out ${idx * 80 + 50}ms infinite`,
          }}
        />
      </div>
      <div
        ...
        style={{
          background: "linear-gradient(90deg,#1E3A46 25%,#2a4f60 50%,#1E3A46 75%)",
          backgroundSize: "200% 100%",
          animation: `shimmer 1.6s ease-in-out ${idx * 80 + 100}ms infinite`,
        }}
      />
      <div className="flex gap-2">
        <div
          ...
          style={{
            background: "linear-gradient(90deg,#1E3A46 25%,#2a4f60 50%,#1E3A46 75%)",
            backgroundSize: "200% 100%",
            animation: `shimmer 1.6s ease-in-out ${idx * 80 + 150}ms infinite`,
          }}
        />
        <div
          ...
          style={{
            background: "linear-gradient(90deg,#1E3A46 25%,#2a4f60 50%,#1E3A46 75%)",
            backgroundSize: "200% 100%",
            animation: `shimmer 1.6s ease-in-out ${idx * 80 + 200}ms infinite`,
          }}
        />
      </div>
    </div>
      ...
      <td colSpan={colSpan} className="py-16 text-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <span
            ...
            style={{ color: "rgba(88,113,125,0.4)" }}
          >
            No incidents found
          </span>
        </div>
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 0 0 1px rgba(88,113,125,0.2), 0 40px 100px rgba(0,0,0,0.6)",
          opacity: mounted ? 1 : 0,
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(88,113,125,0.018) 3px,rgba(88,113,125,0.018) 4px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg,transparent 0%,rgba(180,195,204,0.5) 35%,rgba(88,113,125,0.6) 65%,transparent 100%)",
          }}
        />
        ...
        <div className="relative p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <span
                    ...
                    style={{ animation: "blink 1.3s ease-in-out infinite" }}
                  />
                  <span className="text-[9px] font-mono tracking-[0.25em] text-[#58717D] uppercase select-none">
                    Live
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
              ...
              <Filter
                value={resFilter}
                options={["ALL", "ACTIVE", "RESOLVED", "DISPATCHED"]}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg,rgba(88,113,125,0.35),rgba(88,113,125,0.08),transparent)",
            }}
          />
          ...
          <div className="flex flex-col gap-2 sm:hidden">
            {isLoading ? (
              Array.from({ length: 5 }).map((_, i) => (
                <MobileSkeleton key={i} idx={i} />
              ))
            ) : isError ? (
              <div className="py-12 flex flex-col items-center gap-3">
                <div
                  className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-red-400"
                  style={{
                ...
                <span className="text-[10px] font-mono tracking-[0.22em] text-red-400/60 uppercase">
                  Error loading data
                </span>
              </div>
              ...
              filtered.map((incident, idx) => (
                <MobileCard key={incident._id} incident={incident} idx={idx} />
              ))
            )}
          </div>
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "inset 0 1px 0 rgba(180,195,204,0.04), inset 0 -1px 0 rgba(0,0,0,0.3)",
            }}
          >
            <table className="w-full text-left border-collapse">
              <thead>
                <tr
                  style={{
                    borderBottom: "1px solid rgba(88,113,125,0.15)",
                    background: "rgba(10,14,20,0.5)",
                  }}
                >
                  {/* Always visible */}
                  <th className="py-3 px-4 text-[9px] font-mono tracking-[0.22em] uppercase select-none" style={{ color: "rgba(88,113,125,0.5)" }}>
                    Event ID
                  </th>
                  {/* lg+ only */}
                  <th className="py-3 px-4 text-[9px] font-mono tracking-[0.22em] uppercase select-none hidden lg:table-cell" style={{ color: "rgba(88,113,125,0.5)" }}>
                    Time
                  </th>
                  {/* Always visible */}
                  <th className="py-3 px-4 text-[9px] font-mono tracking-[0.22em] uppercase select-none" style={{ color: "rgba(88,113,125,0.5)" }}>
                  ...
                  {/* md+ only */}
                  <th className="py-3 px-4 text-[9px] font-mono tracking-[0.22em] uppercase select-none hidden md:table-cell" style={{ color: "rgba(88,113,125,0.5)" }}>
                    Type
                  </th>
                  {/* Always visible */}
                  <th className="py-3 px-4 text-[9px] font-mono tracking-[0.22em] uppercase select-none" style={{ color: "rgba(88,113,125,0.5)" }}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span
                  ...
                  style={{ color: "rgba(88,113,125,0.35)" }}
                >
                  Synced
                </span>
